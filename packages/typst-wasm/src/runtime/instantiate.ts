...
import type { InitOutput, WasmBytes, WasmModule } from "../wasm/index";
...
const normalizeWasmBytes = (wasmBytes: WasmBytes): ArrayBuffer | Uint8Array =>
  wasmBytes;
...
export const loadWasmModule = async (
  ...
  const instance = (
    await WebAssembly.instantiate(normalizeWasmBytes(wasmBytes), {
